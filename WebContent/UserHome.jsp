	...
	<nav
		...
		<div class="container-fluid">
			...
			<ul class="nav align-items-center d-md-none">
				...
				<li class="nav-item dropdown"><a class="nav-link" href="profile.jsp"
			...
			<div class="collapse navbar-collapse" id="sidenav-collapse-main">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link "
						href="Borrowed_books.jsp"> <i class="ni ni-planet text-blue"></i>
							Books Borrowed
					</a></li>
					...
					<a class="nav-link " href="home.jsp" onclick="location.href='@Url.Action("Logout")'"> 
			...
			<div class="container-fluid">
				...
				<ul class="navbar-nav align-items-center d-none d-md-flex">
					<li class="nav-item dropdown"><a class="nav-link pr-0"
						href="profile.jsp" role="button" data-toggle="dropdown" aria-haspopup="true"
						aria-expanded="false">
							<div class="media align-items-center">
								<span class="avatar avatar-sm rounded-circle"> <img
									alt="Image placeholder"
							...
							<table class="table align-items-center table-flush">
								...
								<tbody id="myTable">
									...
									<tr>
										...
										<td><%=rs.getInt(5) %></td>
										<td><%=rs.getInt(6) %></td>
										<td><form action = "BorrowedBooks" method="POST">
												<input type="text" name="book_id" hidden value=<%=rs.getInt(1) %>>
												<div class="text-center">
													<button type="submit" class="btn btn-primary my-4">Borrow
													</button>
												</div>
											</form>
											<!-- <script>
